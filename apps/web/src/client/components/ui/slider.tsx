...
const SliderThumb: Component<SliderPrimitive.SliderThumbProps> = (props) => {
  ...
  return (
    <SliderPrimitive.Thumb
      class={cn(
        "top-[-6px] block h-5 w-5 rounded-full border border-background bg-primary ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
        props.class,
      )}
      {...rest}
    >
