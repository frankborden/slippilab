...
Command: npx gltfjsx@6.2.16 peach.glb --types 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    ["Joint_0_Object_50_Material_50.001"]: THREE.MeshStandardMaterial;
    ["Joint_0_Object_51_Material_51.001"]: THREE.MeshStandardMaterial;
    ...
    <group ref={group} {...props} scale={1.15} dispose={null}>
      <group name="peach">
        <group name="Armature">
          ...
          <group name="Joint_0_Object_47">
            <skinnedMesh
              name="mesh_20"
              geometry={nodes.mesh_20.geometry}
              material={materials["Joint_0_Object_47_Material_47.001"]}
          ...
          <group name="Joint_0_Object_50">
            <skinnedMesh
              name="mesh_22"
              geometry={nodes.mesh_22.geometry}
              material={materials["Joint_0_Object_50_Material_50.001"]}
              skeleton={nodes.mesh_22.skeleton}
              position={[-8.089, 0, -3.453]}
              scale={0.001}
            />
          </group>
          <group name="Joint_0_Object_51">
            <skinnedMesh
              name="mesh_23"
              geometry={nodes.mesh_23.geometry}
              material={materials["Joint_0_Object_51_Material_51.001"]}
          ...
          <group name="Joint_67_Object_0_SINGLE">
            <skinnedMesh
              name="mesh_28"
              geometry={nodes.mesh_28.geometry}
              material={materials["Joint_67_Object_0_Material_0.001"]}
              skeleton={nodes.mesh_28.skeleton}
              position={[-8.089, 0, -3.453]}
              scale={0.001}
            />
          </group>
          <group name="Joint_67_Object_1_SINGLE">
            <skinnedMesh
              name="mesh_29"
              geometry={nodes.mesh_29.geometry}
              material={materials["Joint_67_Object_1_Material_1.001"]}
              skeleton={nodes.mesh_29.skeleton}
              position={[-8.089, 0, -3.453]}
              scale={0.001}
            />
          </group>
          <group name="Joint_77_Object_0_SINGLE">
            <skinnedMesh
              name="mesh_30"
