declare const charactersExt: Record<string, string>;
declare const costumeCountsExt: Record<string, number>;
declare const shortCharactersExt: Record<string, string>;
declare const charactersInt: Record<string, string>;
declare const stages: Record<string, string>;
declare const shortStages: Record<string, string>;
declare const actions: Record<string, string>;
declare const attacks: Record<string, string>;
declare const items: Record<string, string>;

type ReplayType = "direct" | "ranked" | "unranked" | "old online" | "offline";
...
type PlayerUpdateWithNana = Required<PlayerUpdate>;
...
export { type Character, type Frame, type GameEnding, type GameSettings, type ItemUpdate, type PlayerInputs, type PlayerSettings, type PlayerState, type PlayerStub, type PlayerUpdate, type PlayerUpdateWithNana, type RenderData, type ReplayData, type ReplayStub, type ReplayType, actions, attacks, charactersExt, charactersInt, costumeCountsExt, items, shortCharactersExt, shortStages, stages };
