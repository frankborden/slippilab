...
export function Inputs() {
  return (
    <div class="grid w-full grid-cols-2 p-6">
      <For
        each={replayStore.renderDatas.filter(
          (renderData) => !renderData.playerState.isNana
        )}
      >
        {(renderData) => (
          <>
            <div>
              <div class="flex gap-1">
                <PlayerBadge port={renderData.playerSettings.port} />
            ...
            <Controller
              inputs={renderData.playerInputs}
...
function Controller(
  props: { inputs: PlayerInputs } & JSX.HTMLAttributes<SVGSVGElement>
) {
  return (
    <svg
    ...
    >
      <path
        id="shell"
        fill={getPlayerColor(replayStore, props.inputs.playerIndex, false)}
      ...
      <circle
        ...
        stroke="black"
        stroke-width={2.5}
        cx={104.7 + props.inputs.processed.joystickX * 34}
        cy={274.5 - props.inputs.processed.joystickY * 34}
        r={35.1}
      />
      <path
        id="cStickCutout"
      ...
      <circle
        ...
        stroke="black"
        stroke-width={2.5}
        cx={395.2 + props.inputs.processed.cStickX * 19.5}
        cy={411.6 - props.inputs.processed.cStickY * 19.5}
        r={24.6}
      />
      <circle
        id="startButton"
        fill={props.inputs.processed.start ? "white" : "gray"}
        stroke="black"
        stroke-width={2.5}
        cx="292.9"
        cy="271.9"
      ...
      <circle
        ...
        fill={props.inputs.physical.a ? "white" : "green"}
        stroke="black"
        stroke-width={2.5}
        cx={479.4}
        cy={279.7}
      ...
      <path
        id="bButton"
        fill={props.inputs.processed.b ? "white" : "red"}
        stroke="black"
        stroke-width={2.5}
      ...
      <path
        id="yButton"
        fill={props.inputs.processed.y ? "white" : "gray"}
        stroke="black"
        stroke-width={2.5}
      ...
      <path
        id="xButton"
        fill={props.inputs.processed.x ? "white" : "gray"}
        stroke="black"
        stroke-width={2.5}
      ...
      <path
        id="zButton"
        fill={props.inputs.processed.z ? "white" : "purple"}
        stroke="black"
        stroke-width={2.5}
...
function Controller2(
  ...
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="grow text-neutral-800"
      viewBox="0 0 585.8 585.8"
      {...props}
    >
      <path
        fill="#1d4ed8"
