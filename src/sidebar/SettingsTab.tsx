  ...
  return (
    <>
      <VStack overflowY="auto" gap="$2">
        ...
        SlippiLab is powered by .slp replay files generated by
        <Anchor external textDecoration="underline" href="https://slippi.gg">
          Project Slippi
        </Anchor>
        but is not affiliated with or endorsed by the Slippi team in any way.
        <Table>
