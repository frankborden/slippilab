...
export const dotProd = function (vec1: Vec2D, vec2: Vec2D): number {
  return vec1.x * vec2.x + vec1.y * vec2.y;
};

export const scalarProd = function (lambda: number, vec: Vec2D): Vec2D {
  return new Vec2D(lambda * vec.x, lambda * vec.y);
};

export const norm = function (vec: Vec2D): number {
  return Math.sqrt(dotProd(vec, vec));
};

export const add = function (vec1: Vec2D, vec2: Vec2D): Vec2D {
  return new Vec2D(vec1.x + vec2.x, vec1.y + vec2.y);
};

export const subtract = function (vec1: Vec2D, vec2: Vec2D): Vec2D {
  return new Vec2D(vec1.x - vec2.x, vec1.y - vec2.y);
};

export const squaredDist = function (center1: Vec2D, center2: Vec2D): number {
  return (
...
export const euclideanDist = function (center1: Vec2D, center2: Vec2D): number {
