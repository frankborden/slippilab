...
export const fd: Stage = {
  ...
  ceiling: [
    [new Vec2D(-50, -55), new Vec2D(-45, -56)],
    [new Vec2D(-45, -56), new Vec2D(45, -56)],
    [new Vec2D(45, -56), new Vec2D(50, -55)],
  ],
  wallL: [
    [new Vec2D(-85.6, 0), new Vec2D(-85.6, -10)],
    [new Vec2D(-85.6, -10), new Vec2D(-65, -20)],
    [new Vec2D(-65, -20), new Vec2D(-65, -30)],
    [new Vec2D(-65, -30), new Vec2D(-60, -47)],
    [new Vec2D(-60, -47), new Vec2D(-50, -55)],
  ],
  wallR: [
    [new Vec2D(85.6, 0), new Vec2D(85.6, -10)],
    [new Vec2D(85.6, -10), new Vec2D(65, -20)],
