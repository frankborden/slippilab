...
export const fountain: Stage = {
  ...
  platform: [
    [new Vec2D(-14.25, 42.75), new Vec2D(14.25, 42.75)],
    [new Vec2D(platL, 22.125), new Vec2D(platR, 22.125)],
    [new Vec2D(-platR, 16.125), new Vec2D(-platL, 16.125)],
  ],
  ground: [
    [new Vec2D(-63.33, 0.62), new Vec2D(-53.5, 0.62)],
    [new Vec2D(-53.5, 0.62), new Vec2D(-51, 0)],
    [new Vec2D(-51, 0), new Vec2D(51, 0)],
    [new Vec2D(51, 0), new Vec2D(53.5, 0.62)],
    [new Vec2D(53.5, 0.62), new Vec2D(63.33, 0.62)],
  ],
  ceiling: [
    [new Vec2D(-19, -49.5), new Vec2D(-41, -42)],
    [new Vec2D(19, -49.5), new Vec2D(41, -42)],
  ],
  wallL: [
    [new Vec2D(-63.35, 0.62), new Vec2D(-63.35, -4.5)],
    [new Vec2D(-63.35, -4.5), new Vec2D(-59.33, -15)],
    [new Vec2D(-59.33, -15), new Vec2D(-56.9, -19.5)],
    [new Vec2D(-56.9, -19.5), new Vec2D(-55, -27)],
    [new Vec2D(-55, -27), new Vec2D(-52, -32)],
    [new Vec2D(-52, -32), new Vec2D(-48, -38)],
    [new Vec2D(-48, -38), new Vec2D(-41, -42)],
    [new Vec2D(-19, -49.5), new Vec2D(-13, -54.5)],
    [new Vec2D(-13, -54.5), new Vec2D(-10, -62)],
    [new Vec2D(-10, -62), new Vec2D(-8.8, -72)],
    [new Vec2D(-8.8, -72), new Vec2D(-8.8, -150)],
  ],
  wallR: [
    [new Vec2D(63.35, 0.62), new Vec2D(63.35, -4.5)],
    [new Vec2D(63.35, -4.5), new Vec2D(59.33, -15)],
