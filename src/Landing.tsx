          ...
          <div class="flex w-full items-center">
            <svg viewBox="0 -3 30 27">
              <path
                ...
                class="animate-draw fill-red-700 stroke-red-800 stroke-[3]"
            ...
            <div class="flex flex-grow flex-col items-center gap-10">
              {/* spacer */}
              <div />
              <div class="flex flex-col gap-2">
                <img class="max-w-xs" src="logo.png" />
                <div class="ml-[0.35em] w-max font-['Comfortaa-Bold'] text-6xl tracking-tighter">
                  Slippi Lab
                </div>
              </div>
              <OpenMenu name={"Start"} />
            ...
            <svg viewBox="0 -3 30 27">
              <path
                transform="translate(15 20) scale(-.1 .1) translate(-500 -500)"
                class="animate-draw fill-blue-700 stroke-blue-800 stroke-[3]"
                stroke-dasharray="1000"
                stroke-dashoffset="1000"
